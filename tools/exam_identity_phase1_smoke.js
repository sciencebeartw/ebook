...
assert.ok(html.includes('examId: displayIdentity.examId || ""'), "grade cards must carry the presentation-class stable exam ID");
assert.ok(html.includes('storedExamId: displayIdentity.storedExamId || ""'), "grade cards must retain the physical storage exam ID");
